...
<head>
    ...
    <title>Painel de controle - Mastermix</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default top-navbar" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Mastermix</a>
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <a class="active-menu" href="index.php"><i class="fa fa-dashboard"></i> Painel</a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <h1 class="page-header">
                            ...
                            Painel <small>Summary of your App</small>
